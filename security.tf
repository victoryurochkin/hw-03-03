variable "security_group_ingress" {
  ...
  default = [
    {
      protocol       = "TCP"
      description    = "СЂР°Р·СЂРµС€РёС‚СЊ РІС…РѕРґСЏС‰РёР№ ssh"
      v4_cidr_blocks = ["0.0.0.0/0"]
      port           = 22
    },
    {
      protocol       = "TCP"
      description    = "СЂР°Р·СЂРµС€РёС‚СЊ РІС…РѕРґСЏС‰РёР№  http"
      v4_cidr_blocks = ["0.0.0.0/0"]
      port           = 80
    },
    {
      protocol       = "TCP"
      description    = "СЂР°Р·СЂРµС€РёС‚СЊ РІС…РѕРґСЏС‰РёР№ https"
      v4_cidr_blocks = ["0.0.0.0/0"]
      port           = 443
    },
  ]
...
variable "security_group_egress" {
  ...
  default = [
    {
      protocol       = "TCP"
      description    = "СЂР°Р·СЂРµС€РёС‚СЊ РІРµСЃСЊ РёСЃС…РѕРґСЏС‰РёР№ С‚СЂР°С„РёРє"
      v4_cidr_blocks = ["0.0.0.0/0"]
      from_port      = 0
      to_port        = 65365
    }
